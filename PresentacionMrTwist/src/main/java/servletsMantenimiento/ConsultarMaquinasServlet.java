 ...
 * @author Chris
 */
public class ConsultarMaquinasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int totalMaquinas = maquinaFachada.contarMaquinas();
            int totalPaginas = (int) Math.ceil((double) totalMaquinas / pageSize);
            ...
            List<Maquina> maquinas = maquinaFachada.consultarMaquinas(pageSize, primerResultado);
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/views/mantenimiento/consultarMaquinas.jsp");
